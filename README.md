...
The system allows users to manage and access books through a command-line interface, with separate roles for users and admin.
...
- library_db.txt → book metadata (title, author, category)  
- books/ → book content files  
- users.txt → user accounts  
- admin_pass.txt → admin password  
...
- Data is handled using standard shell tools (grep, sed, cut, etc.)  
- Books are stored as text files and retrieved when needed  
